...
<section class="relative text-white h-75 md:h-75 flex items-center">
    ...
    <div class="absolute inset-0">
        <img src="<?php echo e(asset('images/price-hero.jpg')); ?>" class="w-full h-full object-cover opacity-90" alt="Hero Background">
    </div>
...
<?php endif; ?>
<?php /**PATH G:\lelesastogharjagga_laravel_new\lelesastogharjaggakarobar_laravel\resources\views/frontend/pricing.blade.php ENDPATH**/ ?>