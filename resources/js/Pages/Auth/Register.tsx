...
export default function Register() {
    ...
    return (
        <GuestAuthLayout title="Create an account" description="Join to save favorites and get updates.">
            <form
                className="space-y-6"
                onSubmit={(e) => {
                    e.preventDefault();
            ...
            >
                <div>
                    ...
                    <Input
                        ...
                        autoComplete="name"
                    />
                    {form.errors.name ? <p className="text-destructive mt-2 text-sm">{form.errors.name}</p> : null}
                </div>
